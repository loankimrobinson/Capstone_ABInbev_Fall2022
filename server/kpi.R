...
values <- reactiveValues(data = stella_beer , 
                         ...
                         rfm_model_dt = rfm_model_dt_default,
...
observeEvent(input$submit,{
  ...
  values$rfm_model_dt <- rfm_model_dt
...
output$sale_rev <- renderText({
  ...
  HTML(paste0("<span style='font-size:20px;padding-top:5px;padding-bottom:5px;color: #231f20; font-weight:bold;'>$", sale_rev,"</span><span style='font-size:18px;'> </span>"))
})
...
output$ave_time <- renderText({
  ...
  HTML(paste0("<span style='font-size:20px;padding-top:5px;padding-bottom:5px;color: #231f20; font-weight:bold;'>", ave_time," Days</span><span style='font-size:18px;'> </span>"))
})
...
output$ave_sale_rev <- renderText({
  ...
  HTML(paste0("<span style='font-size:20px;padding-top:5px;padding-bottom:5px;color: #231f20; font-weight:bold;'>$",ave_sale_rev,"</span><span style='font-size:18px;'> </span>"))
})
...
output$rep_sale_rev <- renderText({
  ...
  HTML(paste0("<span style='font-size:20px;padding-top:5px;padding-bottom:5px;color: #231f20; font-weight:bold;'>", Repurchase_Rate,"</span><span style='font-size:18px;'> </span>"))
})
